...
#The main bin
program: consumable equippable human rat main
	$(CC) build/consumable.o build/equippable.o build/item.o build/creature.o build/human.o build/rat.o build/main.o -o bin/oChre.exe -lm
main:
